    ...
    schemas: {
      ...
      DecideResponse: {
        ...
        properties: {
          ...
          feeVolatilityIndex: { type: ['number', 'null'], minimum: 0, maximum: 1, description: 'Fee stability of the target node (0 = highly volatile, 1 = perfectly stable). Null when no fee data is available.' },
